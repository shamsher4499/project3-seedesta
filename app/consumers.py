...
class WebGroupChatConsumer(AsyncWebsocketConsumer):
      async def connect(self):   
    ...
    # # Receive message from room group
      ...
      @sync_to_async
      def save_message(self, room_id, chat_massage,sender, receiver_id ):
        # user1 = room[0] + room[1]
        # user2 = room[-2] + room[-1]
        ...
        if msg:
          print(chat_massage,receiver_id, sender, "UUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUu")    
